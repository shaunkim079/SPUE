...
data<-list(cal.input=data.frame(P=input_ts$P,E=input_ts$E),
           area_m2=orig_params$area_m2,obs=input_ts$Q_with_state_errors) #obs=input_ts$Q_no_state_errors #obs=input_ts$Q_with_state_errors
...
resample_thetas<-F
start_gibbs_iter<-1
diagnostic_plot_interval<-1e6 #1000
