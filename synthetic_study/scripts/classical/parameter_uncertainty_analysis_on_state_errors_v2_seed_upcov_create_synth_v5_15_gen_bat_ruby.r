...
if(Sys.info()["sysname"]=="Linux"){
  ...
  rscript_runner<-"/datasets/work/LW_TVD_MDBA_WORK/8_Working/7_Shaun/data_backup/kim079/model_optimisation_framework_v2/scripts/parameter_uncertainty_analysis_on_state_errors_v2_seed_upcov_create_synth_v5_15.r"
} else {
  ...
  rscript_runner<-"Y:/scripts/parameter_uncertainty_analysis_on_state_errors_v2_seed_upcov_create_synth_v5_15.r"
...
batch.write.dir<-"scripts/syn_PUE_create_synth_15_ruby"
